    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a href={'/services'}  className="text-gray-600 hover:text-gray-800">Vinyl+one way printing</a>
          </li>
          <li>
            <a href={'/services'}  className="text-gray-600 hover:text-gray-800">Led signboard</a>
          </li>
          <li>
            <a href={'/services'}  className="text-gray-600 hover:text-gray-800">in shop branding</a>
          </li>
          <li>
            <a href={'/services'}  className="text-gray-600 hover:text-gray-800">corporate gifting</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a href="#"  className="text-gray-600 hover:text-gray-800">privacy policies</a>
          </li>
          <li>
            <a href="#"  className="text-gray-600 hover:text-gray-800">terms and condtions </a>
          </li>
        </nav>
      </div>
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© {new Date().getFullYear()} Dspenterprises —
        <a href="https://www.instagram.com/dspenterprises_" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@dspenterprises</a>
      </p>
      <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
        ...
        <a  href="https://www.instagram.com/dspenterprises_" className="ml-3 text-gray-500">
