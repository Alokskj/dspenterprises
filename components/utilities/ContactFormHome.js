  ...
  return (
    <div className="p-6 mr-2  dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <div className="flex items-center mt-8 text-gray-600 dark:text-gray-400">
                            ...
                            <div className="ml-4 text-md tracking-wide font-semibold w-2/3">
                            Plot.No.20/6/19 1st Floor Site-4 industrial area, sahibabad, Ghaziabad -201010
                            </div>
                        </div>
                        ...
                        <div className="flex items-center mt-2 text-gray-600 dark:text-gray-400">
                            ...
                            <div className="ml-4 text-md tracking-wide font-semibold w-40">
                            Ravi.chaudhary@dspenterprises.net
                            </div>
                        </div>
                    </div>
  )
